            ...
            <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav className="mt-6">
                    <div>
                        ...
                        <a onClick={logOut}
                           className={`w-full font-thin uppercase flex items-center p-4 my-2 transition-colors duration-200 justify-start text-gray-500 dark:text-gray-200 hover:text-blue-500`}>Log
                            out</a>
                    </div>
                </nav>
            </div>
